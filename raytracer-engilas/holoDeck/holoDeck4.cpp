...
void checkProgram(GLuint program, const char* name)
{
...
checkProgram(rtProg, "Raytracer");
checkProgram(rastProg, "Rasterizer");
checkProgram(blitProg, "Blitter");
