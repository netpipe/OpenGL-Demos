    ...
    uint32_t seed)
{
        ...
        ++y)
    {
            ...
            ++x)
        {
            ...
            // Different random sequence every frame.
            //
            // This is critical for progressive
            // accumulation.
            ...
            // ------------------------------------------------
            // First intersection metadata.
            //
            // We need this for reconstruction.
            // This is still one extra intersection, but
            // only once per pixel instead of once per bounce.
            // ------------------------------------------------
...
int main()
{
        ...
        window))
    {
        ...
        // reset the image.
        //
        // Once the camera stops, progressive accumulation
        // starts rebuilding the image.
        // ----------------------------------------------------
