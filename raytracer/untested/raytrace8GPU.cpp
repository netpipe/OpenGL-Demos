...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // Animation no longer clears the whole accumulation every frame.
        // The shader locally refreshes the moving sphere's screen region while
        // stationary pixels keep their history and continue converging.
