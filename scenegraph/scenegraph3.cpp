// ============================================================================
// Optimized Scenegraph & Culling Demo with stb_image Textured OBJ Loading
// ============================================================================
...
// Download from: https://github.com/netpipe/OpenGL-OBJ-Loader/blob/main/new/stb_image.h
// ============================================================================
...
GLuint loadTexture(const std::string& filename) {
    ...
    if (!data) {
        ...
        // Procedural 64x64 checkerboard fallback
...
private:
    ...
    // Robust parser handling v, v/vt, v/vt/vn, and v//vn
...
int main() {
    ...
    objNode->color = Vec3(1.0f, 1.0f, 1.0f);
